...
INSERT INTO dispenser_type (name, unit_name, unit_plural, unit_size, manual) VALUES ('Mixer tap', 'ml', 'ml', 25, 0);
INSERT INTO dispenser_type (name, unit_name, unit_plural, unit_size, manual) VALUES ('Dasher', 'dash', 'dashes', 1, 0);
INSERT INTO dispenser_type (name, unit_name, unit_plural, unit_size, manual) VALUES ('Syringe', 'ml', 'ml', 25, 0);
INSERT INTO dispenser_type (name, unit_name, unit_plural, unit_size, manual) VALUES ('Conveyor', 'cherry', 'cherries', 1, 0);
...
INSERT INTO dispenser_type (name, unit_name, unit_plural, unit_size, manual) VALUES ('Umbrella dropper', 'cocktail', 'umbrellas', 1, 0);
INSERT INTO dispenser_type (name, unit_name, unit_plural, unit_size, manual) VALUES ('Manual', 'whatever', 'whatevers', 1, 1);
...
INSERT INTO ingredient (name, dispenser_type_id, dispenser_param, alcoholic) SELECT 'Ice', id, 1, 0 FROM dispenser_type WHERE name = 'Manual';
INSERT INTO ingredient (name, dispenser_type_id, dispenser_param, alcoholic) SELECT 'Sugar', id, 1, 0 FROM dispenser_type WHERE name = 'Manual';

-- Ingredients we have loaded into dispensers (also dispenser configs)
INSERT INTO dispenser (id, dispenser_type_id, ingredient_id, name, rail_position) SELECT  0, id               , NULL, 'Manual',         7080 FROM dispenser_type WHERE name = 'Manual';
...
-- Glass types
INSERT INTO glass_type (id, name, size_ml) VALUES (1, 'Martini', 237);
INSERT INTO glass_type (id, name, size_ml) VALUES (2, 'Wine glass ', 250);


-- Cocktail recipes!
INSERT INTO recipe (name, glass_type_id) VALUES ('Gin and tonic (lemon lime)', 1);
...
INSERT INTO recipe (name, glass_type_id) VALUES ('Gin and tonic (lime lemon)', 1);
...
INSERT INTO recipe (name, glass_type_id) VALUES ('Tequila sunrise', 1);
...
INSERT INTO recipe (name, glass_type_id) VALUES ('Highball', 1);
...
INSERT INTO recipe (name, glass_type_id) VALUES ('Whisky soda', 1);
...
INSERT INTO recipe (name, glass_type_id) VALUES ('Vodka and coke', 1);
