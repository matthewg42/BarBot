...
INSERT INTO dispenser (dispenser_type_id, ingredient_id, name, rail_position) SELECT dispenser_type_id, id, 'Optic 0',             0 FROM ingredient WHERE name = 'Vodka';
INSERT INTO dispenser (dispenser_type_id, ingredient_id, name, rail_position) SELECT dispenser_type_id, id, 'Optic 1',           546 FROM ingredient WHERE name = 'Whisky';
INSERT INTO dispenser (dispenser_type_id, ingredient_id, name, rail_position) SELECT dispenser_type_id, id, 'Optic 2',          1093 FROM ingredient WHERE name = 'Vodka';
INSERT INTO dispenser (dispenser_type_id, ingredient_id, name, rail_position) SELECT dispenser_type_id, id, 'Optic 3',          1640 FROM ingredient WHERE name = 'Gin';
INSERT INTO dispenser (dispenser_type_id, ingredient_id, name, rail_position) SELECT dispenser_type_id, id, 'Optic 4',          2187 FROM ingredient WHERE name = 'Tequila';
INSERT INTO dispenser (dispenser_type_id, ingredient_id, name, rail_position) SELECT dispenser_type_id, id, 'Optic 5',          2734 FROM ingredient WHERE name = 'Rum';

INSERT INTO dispenser (dispenser_type_id, ingredient_id, name, rail_position) SELECT dispenser_type_id, id, 'Pressure 0',       3117 FROM ingredient WHERE name = 'Ginger ale';
INSERT INTO dispenser (dispenser_type_id, ingredient_id, name, rail_position) SELECT dispenser_type_id, id, 'Pressure 1',       3417 FROM ingredient WHERE name = 'Coke';
INSERT INTO dispenser (dispenser_type_id, ingredient_id, name, rail_position) SELECT dispenser_type_id, id, 'Pressure 2',       3746 FROM ingredient WHERE name = 'Lemonade';
INSERT INTO dispenser (dispenser_type_id, ingredient_id, name, rail_position) SELECT dispenser_type_id, id, 'Pressure 3',       4057 FROM ingredient WHERE name = 'Tonic water';
INSERT INTO dispenser (dispenser_type_id, ingredient_id, name, rail_position) SELECT dispenser_type_id, id, 'Pressure 4',       4357 FROM ingredient WHERE name = 'Soda water';
INSERT INTO dispenser (dispenser_type_id, ingredient_id, name, rail_position) SELECT dispenser_type_id, id, 'Pressure 5',       4714 FROM ingredient WHERE name = 'Orange juice';

INSERT INTO dispenser (dispenser_type_id, ingredient_id, name, rail_position) SELECT dispenser_type_id, id, 'Dasher 0',         5058 FROM ingredient WHERE name = 'Angorstura bitters';
INSERT INTO dispenser (dispenser_type_id, ingredient_id, name, rail_position) SELECT dispenser_type_id, id, 'Dasher 1',         5332 FROM ingredient WHERE name = 'Lemon juice';
INSERT INTO dispenser (dispenser_type_id, ingredient_id, name, rail_position) SELECT dispenser_type_id, id, 'Dasher 2',         5605 FROM ingredient WHERE name = 'Tabasco';

INSERT INTO dispenser (dispenser_type_id, ingredient_id, name, rail_position) SELECT dispenser_type_id, id, 'Syringe' ,         5800 FROM ingredient WHERE name = 'Grenadine';
INSERT INTO dispenser (dispenser_type_id, ingredient_id, name, rail_position) SELECT dispenser_type_id, id, 'Conveyor',         5900 FROM ingredient WHERE name = 'Cherry';
INSERT INTO dispenser (dispenser_type_id, ingredient_id, name, rail_position) SELECT dispenser_type_id, id, 'Slice dispenser',  6335 FROM ingredient WHERE name = 'Lime';
INSERT INTO dispenser (dispenser_type_id, ingredient_id, name, rail_position) SELECT dispenser_type_id, id, 'Stirrer dispenser',6792 FROM ingredient WHERE name = 'Good stir';
INSERT INTO dispenser (dispenser_type_id, ingredient_id, name, rail_position) SELECT dispenser_type_id, id, 'Umbrella dropper', 7002 FROM ingredient WHERE name = 'Umbrella';
